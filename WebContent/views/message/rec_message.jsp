					...
					<div id="msg_2-2-section">
						<table id="msg_table">
								...
								<tr>
									...
									<td id="td-2">
										<a id="checkPatProfile" onclick="checkprofile('<%=list.get(i).getSend_id()%>')" style="cursor:pointer">
											<b id="sendId"><%=list.get(i).getSend_id()%></b>
										</a>
									</td>
									<td id="td-2">
										<a href="<%=request.getContextPath()%>/recMsg/details?rec_no=<%=list.get(i).getRec_no()%>">
											<b><%=list.get(i).getRec_body()%></b>
										</a>
									</td>
									<td id="td-2">
										<a href="#">
									...
									<td id="td-2">
										<b><%=list.get(i).getRec_date()%></b>
									</td>
									<td id="td-2" style="width: 30px;">
										<input type="button" value="삭제" onclick="delete_row('<%=list.get(i).getRec_no()%>')" name="delete" style="color:red;">
									</td>
								</tr>
									<% 
								}
